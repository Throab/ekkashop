...
class Services
{
    ...
    static function sendCode($email, $subject, $body)
    {
        ...
        try {
            ...
            $mail->setFrom('no-reply@accounts.admin.com', 'Ekka Shop');
    ...
    static function generateVnPayUrl($orderData)
    {
        ...
        $vnp_Returnurl = $config['app']['url']."/payment-final";
    ...
    static function generateMomoUrl($orderData)
    {
        ...
        $returnUrl = $config['app']['url']."/checkout-final";
        $notifyurl = $config['app']['url']."/atm/ipn_momo.php";
        // Lưu ý: link notifyUrl không phải là dạng localhost/ekkashop
        $bankCode = "SML";
