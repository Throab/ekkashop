...
class OrderModel extends BaseModel
{
    ...
    function getAllOrderItemByUser($order_id)
    {
        $sql = "
            SELECT 
                o.id AS order_id, o.order_code, o.fullname, o.phone, o.address, o.order_date, o.order_status_id, o.total_money, o.coupon_id, o.shipping_fee,
