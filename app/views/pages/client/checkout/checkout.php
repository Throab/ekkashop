                    ...
                    <div class="ec-checkout-leftside col-lg-8 col-md-12 ">
                        ...
                        <div class="ec-checkout-content">
                            ...
                            <div class="ec-checkout-inner">
                                        ...
                                        <span class="ec-bill-option">
                                            ...
                                            <div class="ec-check-bill-form">
                                                ...
                                                <span class="ec-bill-wrap ">
                                                    ...
                                                    <div>
                                                        <select class="form-select form-select-sm mb-3" name="province" id="province" aria-label=".form-select-sm">
                                                    ...
                                                    <br>
                                                    <!-- <div>
                                                        <label>Nhập địa chỉ cụ thể<small class="text-danger ">*</small></label>
                                ...
                                <span class="ec-check-order-btn">
                                    <a href="/coupon" class="btn btn-warning" style="margin-right: 10px;">
                                        Mã giảm giá
                                    </a>
